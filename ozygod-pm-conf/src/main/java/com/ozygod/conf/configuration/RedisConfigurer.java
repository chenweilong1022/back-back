...
import com.ozygod.base.redis.TedisCacheManager;
 ...
 * 类描述：
 *
 * @ConditionalOnProperty 如果 application.properties、application.yml 中没有 spring.redis.host 配置，则不初始化这些 Bean
 * @EnableCaching 加上这个注解是为了支持 @Cacheable、@CachePut、@CacheEvict 等缓存注解
 * @author http://www.spring4all.com/article/937
 */
@Configuration
...
public class RedisConfigurer extends CachingConfigurerSupport {
    ...
    RedisConfigurer(RedisConnectionFactory redisConnectionFactory) {
