...
//
//    @Autowired
//    public AwsS3FileApiController(ResourceLoader resourceLoader) {
...
//        try {
//             requestBody = RequestBody.fromInputStream(file.getInputStream(),1024);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//
...
//
//
//        PutObjectResponse putObjectResponse = s3Client.putObject(PutObjectRequest.builder().bucket("bucket1578104563321").key(name)
//                        .build(), requestBody);
//
//
...
//        resultMap.put("downloadUrl", "/api/files/download/" + PREFIX_IMAGE + "/" + name);
//        resultMap.put("showUrl", "/api/files/show/" + PREFIX_IMAGE + "/" + name);
//        resultMap.put("thumbUrl", "/api/files/show/" + PREFIX_THUMB + "/" + name);
