...
public class GenUtils {
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        String packagePath = "ozygod-pm-model" + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator;
        ...
        if (template.contains("Dao.xml.vm" )) {
            return "ozygod-pm-model" + File.separator + "src" + File.separator +  "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + moduleName + File.separator + className + "Dao.xml";
        }

        if (template.contains("menu.sql.vm" )) {
            return "ozygod-pm-model" + File.separator  + "sql" + File.separator + className.toLowerCase() + File.separator +  className.toLowerCase() + "_menu.sql";
        }


        if (template.contains("index.vue.vm" )) {
            return "ozygod-pm-model" + File.separator + "vue" + File.separator + "views" + File.separator + "modules" +
